...
class ViewController: UIViewController {
    ...
    private func startNewGame() {
        ...
        levelLabel.text = "Level " + String(game.level)
    ...
    private func answerQuestion() {
        ...
        case .incorrect:
            performSegue(withIdentifier: "GameToVerifySegue", sender: self)
        case .standard:
            break
        }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "GameToVerifySegue" {
            let verifyVC = segue.destination as! VerifyViewController
            verifyVC.game = game
            verifyVC.prevVC = self
        }
    }
